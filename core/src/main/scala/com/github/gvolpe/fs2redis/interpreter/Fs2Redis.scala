...
object Fs2Redis {
  ...
  private[fs2redis] def acquireAndRelease[F[_], K, V](
      ...
      uri: RedisURI)(implicit F: Concurrent[F]): (F[Fs2Redis[F, K, V]], Fs2Redis[F, K, V] => F[Unit]) = {
  ...
  def apply[F[_]: Concurrent, K, V](client: Fs2RedisClient,
                                    codec: Fs2RedisCodec[K, V],
  ...
  def stream[F[_]: Concurrent, K, V](client: Fs2RedisClient,
                                     codec: Fs2RedisCodec[K, V],
